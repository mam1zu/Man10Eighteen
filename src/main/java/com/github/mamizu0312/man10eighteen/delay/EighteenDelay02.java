...
public class EighteenDelay02 extends BukkitRunnable {
    //delay02:じゃんけんの処理(勝者p1の場合)
    Man10Eighteen plugin;
    Player p1;
    Player p2;
    int judgetime = 8;
    public EighteenDelay02(Man10Eighteen plugin) {
        this.plugin = plugin;
    }
    public EighteenDelay02(Man10Eighteen plugin, Player p1, Player p2) {
        this.plugin = plugin;
        this.p1 = p1;
        this.p2 = p2;
    }
